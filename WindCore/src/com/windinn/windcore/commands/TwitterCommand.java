...
public class TwitterCommand implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String msg, String[] args) {
		...
		if (sender instanceof Player) {
			...
			player.sendMessage(
					ChatColor.translateAlternateColorCodes('&', plugin.getConfig().getString("messages.twitter.message",
							"&bWindCore&f: The Twitter of the server is < insert URL in config >")));
		}
