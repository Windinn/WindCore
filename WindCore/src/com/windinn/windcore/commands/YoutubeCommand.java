...
public class YoutubeCommand implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String msg, String[] args) {
		...
		if (sender instanceof Player) {
			...
			player.sendMessage(
					ChatColor.translateAlternateColorCodes('&', plugin.getConfig().getString("messages.youtube.message",
							"&bWindCore&f: The YouTube channel of the server is < insert URL in config >")));
		}
